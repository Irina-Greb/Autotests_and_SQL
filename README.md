...
### Задание 2.
Необходимо протестировать статусы заказов. Нужно убедиться, что в базе данных они записываются корректно.
...
2. Нужно проверить, что по треку заказа можно получить данные о заказе.
```
    Шаги автотеста:
